...
description = '''
This program is meant for updating phobius files used 
as proteomic annotation.  Updating from one proteome 
version to another can be difficult. The idea with 
this program is to have one primary phobius results
...
diff file with phobius and use the output with this 
program.'''

parser = argparse.ArgumentParser(description=description)
parser.add_argument('primaryfile',  help='The primary phobius file that will be updated')
parser.add_argument('updatefile', help='Updates to the phobius file')
...
print('Accessions added/update to primary phobius file:')

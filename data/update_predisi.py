...
description = '''
This program is meant for updating predisi files used 
as proteomic annotation.  Updating from one proteome 
version to another can be difficult. The idea with 
this program is to have one primary predisi results
...
diff file with predisi and use the output with this 
program.'''

parser = argparse.ArgumentParser(description=description)
parser.add_argument('primaryfile',  help='The primary predisi file that will be updated')
parser.add_argument('updatefile', help='Updates to the predisi file')
...
print('Accessions added/update to primary predisi file:')
